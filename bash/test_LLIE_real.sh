...
# CUDA_VISIBLE_DEVICES=0 python3  Reti-Diff/test.py -opt options/test_LLIE_real.yml
...
CUDA_VISIBLE_DEVICES=0 python3 /depot/natallah/data/shourya/Reti-Diff-main/Reti-Diff/test.py -opt /depot/natallah/data/shourya/Reti-Diff-main/options/test_LLIE_real.yml
