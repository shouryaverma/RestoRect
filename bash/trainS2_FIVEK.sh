...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m torch.distributed.launch --nproc_per_node=4 --use_env --master_port=4388 /depot/natallah/data/shourya/Reti-Diff-main/Reti-Diff/train.py -opt /depot/natallah/data/shourya/Reti-Diff-main/options/trainS2_FIVEK.yml --launcher pytorch
