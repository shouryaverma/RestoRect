...
class PolarizedHVIColorSpace(nn.Module):
    ...
    def rgb_to_hvi(self, rgb_img):
        """Polarized HVI transformation - eliminates red discontinuity"""
...
class Decom(nn.Module):
    def __init__(self):
        ...
        # Add the missing components to match training checkpoint
    ...
    def forward(self, input):
        ...
        # For inference, we don't need the constraint losses but the 
        # components must exist to load the checkpoint
        return R, L
